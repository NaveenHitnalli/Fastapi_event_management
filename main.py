...
# # In-memory user, event, and changelog databases for simplicity
# users_db = {}
# events_db = {}
# changelogs_db = {}
...
#             return value[:-1]  # Strip 'Z' if sent by Swagger
#         return value
...
# def update_event(event_id: str, updates: EventUpdate, current_user: dict = Depends(get_current_user)):
